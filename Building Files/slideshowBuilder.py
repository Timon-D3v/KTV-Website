...
if (shuffleSlideNumber == 0):
    shuffleSlideClassNumber = ""
else:
    shuffleSlideClassNumber = shuffleSlideNumber
part = ''
...
while numberOutOf < maxNumber + 1:
    ...
    part = part + '<div class="shuffleSlide' + str(shuffleSlideClassNumber) + '">\n\
...
while i < maxNumber:
    secondPart = secondPart + '    <span class="currentSlideDot' + str(shuffleSlideClassNumber) + '" onclick="currentSlide(' + str(i + 1) + ', ' + str(shuffleSlideNumber) + ')"></span>\n'
    i += 1
